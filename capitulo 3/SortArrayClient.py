...
#ejercicio 3.6
print("")
print("Lista del insertSortAndDedupe")
arr.insert(77.40) # Insert 10 items
arr.insert(99)
arr.insert(30.74)
arr.insert(30.74)
...
insertionSortAndDedupe = arr.insertionSortAndDedupe()
print("Array despues de ordenar y eliminar los duplicados:")
arr.traverse()
print(f"Numero de duplicados encontrados: {insertionSortAndDedupe}")
